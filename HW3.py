...
# list_new = list()
# n = int(input("Введите колчество чисел в списке: "))

# for i in range(n):
#     list_new.append(int(input(f'Введите число номер {i + 1}: ')))

# print(f'Получился список: {list_new}')
# x = int(input("Введите нужное число: "))
# count_x = list_new.count(x)
# print(f'В нашем списке число "{x}" присутствует {count_x} раз')
...
# print(f'Ближайшее число к {x} из нашего списка является число {y}')
